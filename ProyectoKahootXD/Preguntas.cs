...
namespace ProyectoKahootXD
{
    public class Preguntas
    {
        ...
        public void getpregunta(int categoria)
        {
            ...
            string query = "SELECT  categoria_id,numero_pregunta, id, enunciado, tipo_respuesta From preguntas WHERE tipo_respuesta = 'Imagen' AND categoria_id = " + categoria.ToString() + " ORDER BY rand() LIMIT 1;";
